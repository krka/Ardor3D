        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if ("v".equals(keyword)) {
                    ...
                    final Vector3 vertex = new Vector3(Double.valueOf(tokens[1]), Double.valueOf(tokens[2]), Double
                            .valueOf(tokens[3]));
                ...
                // if normal vector
                    ...
                    final Vector3 normal = new Vector3(Double.valueOf(tokens[1]), Double.valueOf(tokens[2]), Double
                            .valueOf(tokens[3]));
                ...
                // if material library(ies)
                    ...
                    for (int i = 1; i < tokens.length; i++) {
                        loadMaterialLibrary(tokens[i], resource, materialLibrary);
                    }
                }
                ...
                // if use material command
                    ...
                    // set new material
                    store.setCurrentMaterial(materialLibrary.get(tokens[1]));
                }

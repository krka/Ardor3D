...
public class ShadowedTerrainExample extends ExampleBase {
    ...
    protected void renderExample(final Renderer renderer) {
        ...
        if (!_pssmPass.isInitialised()) {
            ...
            for (int i = 0; i < _pssmPass.getNumOfSplits(); i++) {
                terrain.getTextureClipmap().getTextureState().setTexture(_pssmPass.getShadowMapTexture(i), i + 1);
            }
    ...
    protected void initExample() {
        ...
        try {
            ...
            terrain.setVertexShader(new URLInputSupplier(ResourceLocatorTool.getClassPathResource(
                    ShadowedTerrainExample.class, "com/ardor3d/extension/terrain/shadowedGeometryClipmapShader.vert")));

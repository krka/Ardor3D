...
public class PointSpritesExample extends ExampleBase {
    ...
    private static final String s_vert_pointsprite = "uniform float time;" + "const float a = 3.1415/20;"
            ...
            + "                                                gl_Vertex.y + (10-0.3*radius)*cos(time+a*radius), "
            + "                                                gl_Vertex.z, 1.0);" + "}";

    private static final String s_frag_pointsprite = "uniform sampler2D texture;" + "" + "void main()" + "{"

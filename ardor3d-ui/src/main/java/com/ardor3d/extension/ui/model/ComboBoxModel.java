...
/**
 * An interface describing a data store or model for a UIComboBox. The model should maintain a list of values for a
 * combo box, as well as an optional tool tip and view String override.
 */
public interface ComboBoxModel {
    ...
    /**
     * Sets the value of the item at the given index. If that item already has a name or tooltip set, it is left
     * unchanged.
     * 
     * @param index
     *            the index to add at.
     ...
     * @param index
     *            the index to retrieve
     * @return the view String for the given index. If no specific view is set, the value at that location is converted
     *         with toString().
     */

...
/**
 * A container similar to Swing's {@link javax.swing.JTabbedPane} in which multiple components may be contained and
...
public class UITabbedPane extends UIPanel {
    ...
    public void removeTab(final int index) {
        ...
        // If our previously viewed tab was above the removed index, or we were at the end of the stack, decrement to

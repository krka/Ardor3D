...
public class OrientedBox extends Mesh {
    ...
    private void setVertexData() {
        ...
        _meshData.getVertexBuffer().put(_vectorStore[0].getXf()).put(_vectorStore[0].getYf()).put(
                _vectorStore[0].getZf());
        _meshData.getVertexBuffer().put(_vectorStore[1].getXf()).put(_vectorStore[1].getYf()).put(
                _vectorStore[1].getZf());
        _meshData.getVertexBuffer().put(_vectorStore[5].getXf()).put(_vectorStore[5].getYf()).put(
                _vectorStore[5].getZf());
        _meshData.getVertexBuffer().put(_vectorStore[3].getXf()).put(_vectorStore[3].getYf()).put(
                _vectorStore[3].getZf());
        ...
        _meshData.getVertexBuffer().put(_vectorStore[3].getXf()).put(_vectorStore[3].getYf()).put(
                _vectorStore[3].getZf());
        _meshData.getVertexBuffer().put(_vectorStore[6].getXf()).put(_vectorStore[6].getYf()).put(
                _vectorStore[6].getZf());
        _meshData.getVertexBuffer().put(_vectorStore[2].getXf()).put(_vectorStore[2].getYf()).put(
                _vectorStore[2].getZf());
        ...
        _meshData.getVertexBuffer().put(_vectorStore[1].getXf()).put(_vectorStore[1].getYf()).put(
                _vectorStore[1].getZf());
        _meshData.getVertexBuffer().put(_vectorStore[4].getXf()).put(_vectorStore[4].getYf()).put(
                _vectorStore[4].getZf());
        _meshData.getVertexBuffer().put(_vectorStore[7].getXf()).put(_vectorStore[7].getYf()).put(
                _vectorStore[7].getZf());
